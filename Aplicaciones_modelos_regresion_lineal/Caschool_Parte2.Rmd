...
Recordemos que para hacer inferencias a los parámetros estimados se tiene la prueba de hipótesis
...
# Intervalo de confianza para los parametros estimados

Un intervalo de confianza $100(1-\alpha)%$ para $\beta_{i}$
